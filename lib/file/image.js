...
var FileImageErrorDimm = function FileImageErrorDimm(message, dimm, dimmRequired) {
    this.name = 'FileImageErrorDimm';
    this.message = (message || '');
    this.dimm = dimm || {width: {min: 0, max: 0}, height: {min: 0, height: 0}};
    this.dimmRequired = dimmRequired || {width: {min: 0, max: 0}, height: {min: 0, height: 0}};
};

FileImageErrorDimm.prototype = new Error();
